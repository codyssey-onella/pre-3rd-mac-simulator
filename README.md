...
같은 입력, 전처리(flatten / 인덱스 생성)는 측정에서 빼고, MAC 함수만 20000회 평균.

실행 환경: 로컬 `python3 main.py` 모드 2.

| 크기 | 1. 기존 2D (ms) | 2. 1D flatten (ms) | 3. enum IndexMap (ms) |
| --- | --- | --- | --- |
| 3×3 | 0.0011 | 0.0006 | 0.0004 |
| 5×5 | 0.0023 | 0.0014 | 0.0006 |
| 13×13 | 0.0109 | 0.0076 | 0.0013 |
| 25×25 | 0.0381 | 0.0305 | 0.0021 |
